        ...
        >
          ...
          <div className="flex justify-center mb-6">
            <p className="text-center text-sm text-gray-500 font-quicksand flex items-center gap-2">
              ...
              <Link className="text-brown-two font-bold px-3 py-1 bg-cream border border-brown/30 rounded-full hover:bg-brown hover:text-white transition-colors duration-300" to="/signin">
                Log In
              </Link>
            </p>
          </div>
          ...
          <div className="flex flex-col font-quicksand text-brown-two ">
            <label className="text-xs uppercase ml-2 font-semibold">Full Name</label>
            <input
            ...
            {error && <p className="text-red-500 pt-4 text-center text-sm font-bold animate-pulse">{error}</p>}
          </div>
        </form>
      </main>
